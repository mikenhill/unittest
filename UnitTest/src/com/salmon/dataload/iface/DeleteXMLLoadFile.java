 ...
 */
public final class DeleteXMLLoadFile {
    ...
    private static final String CLASSNAME = DeleteXMLLoadFile.class.getName();
     ...
     */
    public DeleteXMLLoadFile(final String sourceFilePath, final String sourceFilePrefix) {
    ...
    public static void main(final String[] args) { 
        DeleteXMLLoadFile validate=null;
        if (args.length == NUM_ARGUMENTS && args[SOURCE_FILE_PATH].length() > 0 && args[SOURCE_FILE_PREFIX].length() > 0               
            ...
            validate = new DeleteXMLLoadFile(args[SOURCE_FILE_PATH], args[SOURCE_FILE_PREFIX]);
            validate.run();
