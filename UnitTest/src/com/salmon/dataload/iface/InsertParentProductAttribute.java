...
public class InsertParentProductAttribute {
    ...
    private static final String CLASSNAME = InsertParentProductAttribute.class.getName();
    ...
    public static void main(final String[] args) {
        ...
        {
            LOGGER.logp(Level.INFO, CLASSNAME, methodName, "Process to create a parent product attribute");
            InsertParentProductAttribute insertProductAttribute = new InsertParentProductAttribute();
            insertProductAttribute.run(args[JDBC_DRIVER], 
                                       args[DB_URL], 
                                       args[DB_USERNAME],
                                       args[DB_PASSWORD]);
            
        } else {
            LOGGER.logp(Level.SEVERE, CLASSNAME, methodName, "Invalid arguments passed to InsertParentProductAttribute");
    ...
    public void run(String jdbcDriver, String dbURL, String dbUserName, String dbPassword) {
        ...
        try {
            ...
            monitiseEtlHelper.createParentProductAttribute();        
